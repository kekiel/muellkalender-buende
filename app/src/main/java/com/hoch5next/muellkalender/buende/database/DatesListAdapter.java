...
public class DatesListAdapter extends FirebaseListAdapter<Trashdate> {
    ...
    private static SimpleDateFormat sdfDateText = new SimpleDateFormat("EEEE, dd.MMMM yyyy");
    ...
    protected void populateView(View view, Trashdate model) {
        ...
        ((TextView) view.findViewById(R.id.trash_type_text)).setText(model.getType());
